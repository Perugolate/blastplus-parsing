...
class test_blast_parse(unittest.TestCase):
    ...
    def test_blast_in(self):
        known_frame = pandas.io.pickle.read_pickle("tests/test_frame.pkl")
        test_frame = blast_in("tests/outfmt6.all.uniq")
        try:
    ...
    def test_genus(self):
        known_series = pandas.io.pickle.read_pickle("tests/test_series.pkl")
        known_frame = pandas.io.pickle.read_pickle("tests/test_frame.pkl")
